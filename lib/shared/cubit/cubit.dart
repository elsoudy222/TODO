...
import 'package:todo_app/modules/archieve/unit.dart';
import 'package:todo_app/modules/new/menu.dart';
import 'package:todo_app/modules/tap/done.dart';
...
class Cubit_tst extends Cubit<Status>
{
  ...
  int indexer = 0;
  List<String>app_bar_title =['Menu',  'Done' , 'Archived'];
  List<Widget>taps = [Menu(),Done(),Archieve()];
  bool add_note =  false;
